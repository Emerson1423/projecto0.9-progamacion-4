...
<div class="container">
    ...
    <form action="{{ route('pagos.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <select class="form-control @error('orden_Id') is-invalid @enderror" id="orden_Id" name="orden_Id" required>
                ...
                @foreach($ordenes as $orden)
                    <option value="{{ $orden->orden_Id }}" {{ old('orden_Id') == $orden->orden_Id ? 'selected' : '' }}>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('tarjeta_ultimos') is-invalid @enderror" id="tarjeta_ultimos" name="tarjeta_ultimos" value="{{ old('tarjeta_ultimos') }}" required maxlength="4" pattern="\d{4}">
